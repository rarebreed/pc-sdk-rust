...
**classification_types** | **Vec<String>** | The site associated to the outbound route. | 
**enabled** | Option<**bool**> |  | [optional]
**distribution** | Option<**String**> |  | [optional]
**external_trunk_bases** | Option<[**Vec<crate::models::DomainEntityRef>**](DomainEntityRef.md)> | Trunk base settings of trunkType \"EXTERNAL\".  This base must also be set on an edge logical interface for correct routing. | [optional]
**site** | Option<[**crate::models::Site**](Site.md)> |  | [optional]
**managed** | Option<**bool**> | Is this outbound route being managed remotely. | [optional][readonly]
