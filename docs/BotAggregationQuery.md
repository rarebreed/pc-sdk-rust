...
**filter** | Option<[**crate::models::BotAggregateQueryFilter**](BotAggregateQueryFilter.md)> |  | [optional]
...
**views** | Option<[**Vec<crate::models::BotAggregationView>**](BotAggregationView.md)> | Custom derived metric views | [optional]
