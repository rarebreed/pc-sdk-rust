...
**phone_meta_base** | [**crate::models::DomainEntityRef**](DomainEntityRef.md) |  | 
**lines** | [**Vec<crate::models::LineBase>**](LineBase.md) | The list of linebases associated with the phone base. | 
