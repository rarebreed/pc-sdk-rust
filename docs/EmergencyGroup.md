...
**enabled** | Option<**bool**> | True if an emergency is occurring and the associated emergency call flow(s) should be used.  False otherwise. | [optional]
**emergency_call_flows** | Option<[**Vec<crate::models::EmergencyCallFlow>**](EmergencyCallFlow.md)> | The emergency call flow(s) to use during an emergency. | [optional]
