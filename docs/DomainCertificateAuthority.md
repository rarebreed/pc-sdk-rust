...
**_type** | **String** | The certificate authorities type.  Managed certificate authorities are generated and maintained by Interactive Intelligence.  These are read-only and not modifiable by clients.  Remote authorities are customer managed. | 
**services** | **Vec<String>** | The service(s) that the authority can be used to authenticate. | 
**certificate_details** | Option<[**Vec<crate::models::CertificateDetails>**](CertificateDetails.md)> | The details of the parsed certificate(s). | [optional]
