...
**managed** | Option<**bool**> | Is this edge group being managed remotely. | [optional]
**hybrid** | Option<**bool**> | Is this edge group hybrid. | [optional]
**edge_trunk_base_assignment** | [**crate::models::TrunkBaseAssignment**](TrunkBaseAssignment.md) |  | 
**phone_trunk_bases** | [**Vec<crate::models::TrunkBase>**](TrunkBase.md) | Trunk base settings of trunkType \"PHONE\" to inherit to edge logical interface for phone communication. | 
