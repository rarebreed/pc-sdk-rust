...
**dnis** | Option<**Vec<String>**> | The phone number(s) to contact the IVR by.  Each phone number must be unique and not in use by another resource.  For example, a user and an iVR cannot have the same phone number. | [optional]
**open_hours_flow** | Option<[**crate::models::DomainEntityRef**](DomainEntityRef.md)> |  | [optional]
**closed_hours_flow** | Option<[**crate::models::DomainEntityRef**](DomainEntityRef.md)> |  | [optional]
**holiday_hours_flow** | Option<[**crate::models::DomainEntityRef**](DomainEntityRef.md)> |  | [optional]
**schedule_group** | Option<[**crate::models::DomainEntityRef**](DomainEntityRef.md)> |  | [optional]
