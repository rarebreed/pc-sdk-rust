...
**filter** | Option<[**crate::models::JourneyAggregateQueryFilter**](JourneyAggregateQueryFilter.md)> |  | [optional]
...
**views** | Option<[**Vec<crate::models::JourneyAggregationView>**](JourneyAggregationView.md)> | Custom derived metric views | [optional]
