...
**trunk_metabase** | [**crate::models::DomainEntityRef**](DomainEntityRef.md) |  | 
...
**managed** | Option<**bool**> | Is this trunk being managed remotely. This property is synchronized with the managed property of the Edge Group to which it is assigned. | [optional]
