...
**time_zone** | Option<**String**> | The timezone the schedules are a part of.  This is not a schedule property to allow a schedule to be used in multiple timezones. | [optional]
**open_schedules** | Option<[**Vec<crate::models::DomainEntityRef>**](DomainEntityRef.md)> | The schedules defining the hours an organization is open. | [optional]
**closed_schedules** | Option<[**Vec<crate::models::DomainEntityRef>**](DomainEntityRef.md)> | The schedules defining the hours an organization is closed. | [optional]
**holiday_schedules** | Option<[**Vec<crate::models::DomainEntityRef>**](DomainEntityRef.md)> | The schedules defining the hours an organization is closed for the holidays. | [optional]
