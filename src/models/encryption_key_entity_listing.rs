...
pub struct EncryptionKeyEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::EncryptionKey>>,
...
impl EncryptionKeyEntityListing {
    pub fn new() -> EncryptionKeyEntityListing {
