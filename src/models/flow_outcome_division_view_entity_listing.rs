...
pub struct FlowOutcomeDivisionViewEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::FlowOutcomeDivisionView>>,
...
impl FlowOutcomeDivisionViewEntityListing {
    pub fn new() -> FlowOutcomeDivisionViewEntityListing {
