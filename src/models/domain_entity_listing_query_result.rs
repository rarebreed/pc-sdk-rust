...
pub struct DomainEntityListingQueryResult {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::QueryResult>>,
...
impl DomainEntityListingQueryResult {
    pub fn new() -> DomainEntityListingQueryResult {
