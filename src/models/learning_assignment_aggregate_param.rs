...
pub struct LearningAssignmentAggregateParam {
    ...
    #[serde(rename = "filter")]
    pub filter: Box<crate::models::LearningAssignmentAggregateQueryRequestFilter>,
}

impl LearningAssignmentAggregateParam {
    pub fn new(interval: String, filter: crate::models::LearningAssignmentAggregateQueryRequestFilter) -> LearningAssignmentAggregateParam {
