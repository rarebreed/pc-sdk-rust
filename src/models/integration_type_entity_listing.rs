...
pub struct IntegrationTypeEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::IntegrationType>>,
...
impl IntegrationTypeEntityListing {
    pub fn new() -> IntegrationTypeEntityListing {
