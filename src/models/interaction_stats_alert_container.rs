...
pub struct InteractionStatsAlertContainer {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::InteractionStatsAlert>>,
...
impl InteractionStatsAlertContainer {
    pub fn new() -> InteractionStatsAlertContainer {
