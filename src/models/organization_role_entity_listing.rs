...
pub struct OrganizationRoleEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::DomainOrganizationRole>>,
...
impl OrganizationRoleEntityListing {
    pub fn new() -> OrganizationRoleEntityListing {
