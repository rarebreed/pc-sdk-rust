...
pub struct SchemaCategoryEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::SchemaCategory>>,
...
impl SchemaCategoryEntityListing {
    pub fn new() -> SchemaCategoryEntityListing {
