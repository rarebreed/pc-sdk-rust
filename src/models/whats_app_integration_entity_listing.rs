...
pub struct WhatsAppIntegrationEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::WhatsAppIntegration>>,
...
impl WhatsAppIntegrationEntityListing {
    pub fn new() -> WhatsAppIntegrationEntityListing {
