...
pub struct Line {
    ...
    pub template: Option<Box<crate::models::DomainEntityRef>>,
    ...
    pub logged_in_user: Option<Box<crate::models::DomainEntityRef>>,
    #[serde(rename = "defaultForUser", skip_serializing_if = "Option::is_none")]
    pub default_for_user: Option<Box<crate::models::DomainEntityRef>>,
