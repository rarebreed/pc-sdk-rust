...
pub struct WritableDialerContact {
...
impl WritableDialerContact {
    pub fn new(contact_list_id: String, data: ::std::collections::HashMap<String, serde_json::Value>) -> WritableDialerContact {
