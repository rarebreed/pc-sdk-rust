...
pub struct DomainEntityListingSurveyForm {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::SurveyForm>>,
...
impl DomainEntityListingSurveyForm {
    pub fn new() -> DomainEntityListingSurveyForm {
