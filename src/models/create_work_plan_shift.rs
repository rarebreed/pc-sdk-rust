...
pub struct CreateWorkPlanShift {
    /// Name of the shift
    #[serde(rename = "name")]
    pub name: String,
    ...
    pub activities: Option<Vec<crate::models::CreateWorkPlanActivity>>,
}

impl CreateWorkPlanShift {
    /// Shift in a work plan
    pub fn new(name: String) -> CreateWorkPlanShift {
        CreateWorkPlanShift {
            name,
            days: None,
