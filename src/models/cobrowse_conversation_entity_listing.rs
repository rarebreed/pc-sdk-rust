...
pub struct CobrowseConversationEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::CobrowseConversation>>,
...
impl CobrowseConversationEntityListing {
    pub fn new() -> CobrowseConversationEntityListing {
