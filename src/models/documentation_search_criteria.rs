...
pub struct DocumentationSearchCriteria {
    ...
    pub group: Option<Vec<crate::models::DocumentationSearchCriteria>>,
...
impl DocumentationSearchCriteria {
    pub fn new(_type: Type) -> DocumentationSearchCriteria {
