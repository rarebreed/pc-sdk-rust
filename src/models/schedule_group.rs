...
pub struct ScheduleGroup {
    ...
    #[serde(rename = "openSchedules", skip_serializing_if = "Option::is_none")]
    pub open_schedules: Option<Vec<crate::models::DomainEntityRef>>,
    /// The schedules defining the hours an organization is closed.
    #[serde(rename = "closedSchedules", skip_serializing_if = "Option::is_none")]
    pub closed_schedules: Option<Vec<crate::models::DomainEntityRef>>,
    /// The schedules defining the hours an organization is closed for the holidays.
    #[serde(rename = "holidaySchedules", skip_serializing_if = "Option::is_none")]
    pub holiday_schedules: Option<Vec<crate::models::DomainEntityRef>>,
...
impl ScheduleGroup {
    ...
    pub fn new(name: String) -> ScheduleGroup {
        ScheduleGroup {
            id: None,
            name,
            division: None,
            ...
            time_zone: None,
            open_schedules: None,
            closed_schedules: None,
            holiday_schedules: None,
            self_uri: None,
        }
    }
}
