...
pub struct DocumentationSearchResponse {
    ...
    pub results: Vec<crate::models::DocumentationResult>,
}

impl DocumentationSearchResponse {
    pub fn new(total: i64, page_count: i32, page_size: i32, page_number: i32, types: Vec<String>, results: Vec<crate::models::DocumentationResult>) -> DocumentationSearchResponse {
