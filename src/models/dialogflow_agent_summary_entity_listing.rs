...
pub struct DialogflowAgentSummaryEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::DialogflowAgentSummary>>,
...
impl DialogflowAgentSummaryEntityListing {
    pub fn new() -> DialogflowAgentSummaryEntityListing {
