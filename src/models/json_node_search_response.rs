...
pub struct JsonNodeSearchResponse {
...
impl JsonNodeSearchResponse {
    pub fn new(total: i64, page_count: i32, page_size: i32, page_number: i32, types: Vec<String>, results: serde_json::Value) -> JsonNodeSearchResponse {
