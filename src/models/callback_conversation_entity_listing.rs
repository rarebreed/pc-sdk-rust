...
pub struct CallbackConversationEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::CallbackConversation>>,
...
impl CallbackConversationEntityListing {
    pub fn new() -> CallbackConversationEntityListing {
