...
pub struct EmergencyGroup {
    ...
    #[serde(rename = "emergencyCallFlows", skip_serializing_if = "Option::is_none")]
    pub emergency_call_flows: Option<Vec<crate::models::EmergencyCallFlow>>,
...
impl EmergencyGroup {
    ...
    pub fn new(name: String) -> EmergencyGroup {
        EmergencyGroup {
            id: None,
            name,
            division: None,
