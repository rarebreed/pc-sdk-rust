...
pub struct SmsPhoneNumberEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::SmsPhoneNumber>>,
...
impl SmsPhoneNumberEntityListing {
    pub fn new() -> SmsPhoneNumberEntityListing {
