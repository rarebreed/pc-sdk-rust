...
pub struct RecordingJobEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::RecordingJob>>,
...
impl RecordingJobEntityListing {
    pub fn new() -> RecordingJobEntityListing {
