...
pub struct LineIntegrationEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::LineIntegration>>,
...
impl LineIntegrationEntityListing {
    pub fn new() -> LineIntegrationEntityListing {
