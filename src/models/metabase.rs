...
impl Metabase {
    pub fn new(name: String) -> Metabase {
        Metabase {
            id: None,
            name,
            division: None,
...
pub enum Type {
    ...
    EXTERNAL,
    #[serde(rename = "EXTERNAL_PCV")]
    EXTERNALPCV,
    #[serde(rename = "EXTERNAL_PCV_AWS")]
    EXTERNALPCVAWS,
    #[serde(rename = "EXTERNAL_BYOC_CARRIER")]
    EXTERNALBYOCCARRIER,
    #[serde(rename = "EXTERNAL_BYOC_PBX")]
    EXTERNALBYOCPBX,
    #[serde(rename = "STATION_CDM")]
    STATIONCDM,
    #[serde(rename = "STATION_CDM_WEBRTC")]
    STATIONCDMWEBRTC,
    #[serde(rename = "STATION")]
    STATION,
    #[serde(rename = "TIE")]
    TIE,
    #[serde(rename = "TIE_DIRECT")]
    TIEDIRECT,
    #[serde(rename = "TIE_INDIRECT")]
    TIEINDIRECT,
    #[serde(rename = "TIE_CLOUD_PROXY")]
    TIECLOUDPROXY,
}
