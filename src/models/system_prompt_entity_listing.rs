...
pub struct SystemPromptEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::SystemPrompt>>,
...
impl SystemPromptEntityListing {
    pub fn new() -> SystemPromptEntityListing {
