...
pub struct NumberPlan {
    ...
    #[serde(rename = "normalizedFormat", skip_serializing_if = "Option::is_none")]
    pub normalized_format: Option<String>,
    #[serde(rename = "priority", skip_serializing_if = "Option::is_none")]
    pub priority: Option<i32>,
    #[serde(rename = "numbers", skip_serializing_if = "Option::is_none")]
    pub numbers: Option<Vec<crate::models::Number>>,
    #[serde(rename = "digitLength", skip_serializing_if = "Option::is_none")]
    pub digit_length: Option<Box<crate::models::DigitLength>>,
...
impl NumberPlan {
    pub fn new(name: String) -> NumberPlan {
        NumberPlan {
            id: None,
            name,
            division: None,
