...
pub struct UserLanguageEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::UserRoutingLanguage>>,
...
impl UserLanguageEntityListing {
    pub fn new() -> UserLanguageEntityListing {
