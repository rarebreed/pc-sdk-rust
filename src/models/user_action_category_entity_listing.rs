...
pub struct UserActionCategoryEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::UserActionCategory>>,
...
impl UserActionCategoryEntityListing {
    pub fn new() -> UserActionCategoryEntityListing {
