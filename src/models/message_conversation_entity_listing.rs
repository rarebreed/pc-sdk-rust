...
pub struct MessageConversationEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::EmailConversation>>,
...
impl MessageConversationEntityListing {
    pub fn new() -> MessageConversationEntityListing {
