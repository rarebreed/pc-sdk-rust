...
pub struct DevelopmentActivityAggregateQueryResponseData {
    ...
    pub metrics: Option<Vec<crate::models::DevelopmentActivityAggregateQueryResponseMetric>>,
}

impl DevelopmentActivityAggregateQueryResponseData {
    pub fn new() -> DevelopmentActivityAggregateQueryResponseData {
