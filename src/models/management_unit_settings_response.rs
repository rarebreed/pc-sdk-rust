...
pub struct ManagementUnitSettingsResponse {
    ...
    pub scheduling: Option<Box<crate::models::SchedulingSettingsResponse>>,
...
impl ManagementUnitSettingsResponse {
    pub fn new(metadata: crate::models::WfmVersionedEntityMetadata) -> ManagementUnitSettingsResponse {
