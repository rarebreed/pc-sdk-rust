...
pub struct BuAsyncAgentSchedulesQueryResponse {
    ...
    pub result: Option<Box<crate::models::BuAgentSchedulesQueryResponse>>,
...
impl BuAsyncAgentSchedulesQueryResponse {
    pub fn new() -> BuAsyncAgentSchedulesQueryResponse {
