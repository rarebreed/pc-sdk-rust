...
pub struct AnalyticsConversation {
    ...
    pub participants: Option<Vec<crate::models::AnalyticsParticipant>>,
}

impl AnalyticsConversation {
    pub fn new() -> AnalyticsConversation {
