...
pub struct ReportingExportJobListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::ReportingExportJobResponse>>,
...
impl ReportingExportJobListing {
    pub fn new() -> ReportingExportJobListing {
