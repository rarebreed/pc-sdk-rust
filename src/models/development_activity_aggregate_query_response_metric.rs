...
pub struct DevelopmentActivityAggregateQueryResponseMetric {
    /// The metric this applies to
    #[serde(rename = "metric", skip_serializing_if = "Option::is_none")]
    pub metric: Option<Metric>,
    #[serde(rename = "stats", skip_serializing_if = "Option::is_none")]
    pub stats: Option<Box<crate::models::DevelopmentActivityAggregateQueryResponseStatistics>>,
}

impl DevelopmentActivityAggregateQueryResponseMetric {
    pub fn new() -> DevelopmentActivityAggregateQueryResponseMetric {
