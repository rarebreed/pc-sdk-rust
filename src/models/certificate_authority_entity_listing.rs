...
pub struct CertificateAuthorityEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::DomainCertificateAuthority>>,
...
impl CertificateAuthorityEntityListing {
    pub fn new() -> CertificateAuthorityEntityListing {
