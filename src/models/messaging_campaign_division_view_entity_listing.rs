...
pub struct MessagingCampaignDivisionViewEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::MessagingCampaignDivisionView>>,
...
impl MessagingCampaignDivisionViewEntityListing {
    pub fn new() -> MessagingCampaignDivisionViewEntityListing {
