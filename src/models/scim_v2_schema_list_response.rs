...
pub struct ScimV2SchemaListResponse {
    ...
    pub resources: Option<Vec<crate::models::ScimV2SchemaDefinition>>,
}

impl ScimV2SchemaListResponse {
    /// Defines the list response for SCIM resource types.
    pub fn new() -> ScimV2SchemaListResponse {
