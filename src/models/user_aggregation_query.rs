...
pub struct UserAggregationQuery {
    ...
    pub filter: Option<Box<crate::models::UserAggregateQueryFilter>>,
    ...
    pub views: Option<Vec<crate::models::UserAggregationView>>,
...
impl UserAggregationQuery {
    pub fn new(interval: String, metrics: Vec<Metrics>) -> UserAggregationQuery {
