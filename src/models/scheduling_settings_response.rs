...
pub struct SchedulingSettingsResponse {
    ...
    pub planning_period: Option<Box<crate::models::PlanningPeriodSettings>>,
...
impl SchedulingSettingsResponse {
    /// Scheduling Settings
    pub fn new() -> SchedulingSettingsResponse {
