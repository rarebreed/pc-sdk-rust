...
pub struct AttemptLimitsEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::AttemptLimits>>,
...
impl AttemptLimitsEntityListing {
    pub fn new() -> AttemptLimitsEntityListing {
