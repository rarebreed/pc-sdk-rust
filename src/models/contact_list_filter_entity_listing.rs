...
pub struct ContactListFilterEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::ContactListFilter>>,
...
impl ContactListFilterEntityListing {
    pub fn new() -> ContactListFilterEntityListing {
