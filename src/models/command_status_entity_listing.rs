...
pub struct CommandStatusEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::CommandStatus>>,
...
impl CommandStatusEntityListing {
    pub fn new() -> CommandStatusEntityListing {
