...
pub struct DomainEntityListingEvaluationForm {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::EvaluationForm>>,
...
impl DomainEntityListingEvaluationForm {
    pub fn new() -> DomainEntityListingEvaluationForm {
