...
pub struct DocumentAuditEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::DocumentAudit>>,
...
impl DocumentAuditEntityListing {
    pub fn new() -> DocumentAuditEntityListing {
