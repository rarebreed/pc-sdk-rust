...
pub struct SystemPromptAssetEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::SystemPromptAsset>>,
...
impl SystemPromptAssetEntityListing {
    pub fn new() -> SystemPromptAssetEntityListing {
