...
pub struct QueueObservationQueryResponse {
    ...
    pub results: Option<Vec<crate::models::QueueObservationDataContainer>>,
}

impl QueueObservationQueryResponse {
    pub fn new() -> QueueObservationQueryResponse {
