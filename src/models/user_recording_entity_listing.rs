...
pub struct UserRecordingEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::UserRecording>>,
...
impl UserRecordingEntityListing {
    pub fn new() -> UserRecordingEntityListing {
