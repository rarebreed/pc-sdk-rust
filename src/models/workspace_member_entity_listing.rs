...
pub struct WorkspaceMemberEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::WorkspaceMember>>,
...
impl WorkspaceMemberEntityListing {
    pub fn new() -> WorkspaceMemberEntityListing {
