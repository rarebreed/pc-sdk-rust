...
pub struct ConsumingResourcesEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::Dependency>>,
...
impl ConsumingResourcesEntityListing {
    pub fn new() -> ConsumingResourcesEntityListing {
