...
pub struct SchemaReferenceEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::DomainSchemaReference>>,
...
impl SchemaReferenceEntityListing {
    pub fn new() -> SchemaReferenceEntityListing {
