...
pub struct CampaignRuleEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::CampaignRule>>,
...
impl CampaignRuleEntityListing {
    pub fn new() -> CampaignRuleEntityListing {
