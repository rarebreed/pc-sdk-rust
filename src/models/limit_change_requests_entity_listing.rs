...
pub struct LimitChangeRequestsEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::LimitChangeRequestDetails>>,
...
impl LimitChangeRequestsEntityListing {
    pub fn new() -> LimitChangeRequestsEntityListing {
