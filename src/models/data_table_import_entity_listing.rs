...
pub struct DataTableImportEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::DataTableImportJob>>,
...
impl DataTableImportEntityListing {
    pub fn new() -> DataTableImportEntityListing {
