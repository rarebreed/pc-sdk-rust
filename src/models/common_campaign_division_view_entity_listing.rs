...
pub struct CommonCampaignDivisionViewEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::CommonCampaignDivisionView>>,
...
impl CommonCampaignDivisionViewEntityListing {
    pub fn new() -> CommonCampaignDivisionViewEntityListing {
