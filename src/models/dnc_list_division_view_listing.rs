...
pub struct DncListDivisionViewListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::DncListDivisionView>>,
...
impl DncListDivisionViewListing {
    pub fn new() -> DncListDivisionViewListing {
