...
pub struct ScreenRecordingSessionListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::ScreenRecordingSession>>,
...
impl ScreenRecordingSessionListing {
    pub fn new() -> ScreenRecordingSessionListing {
