...
pub struct FacebookIntegrationEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::FacebookIntegration>>,
...
impl FacebookIntegrationEntityListing {
    pub fn new() -> FacebookIntegrationEntityListing {
