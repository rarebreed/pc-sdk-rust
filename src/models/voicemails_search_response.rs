...
pub struct VoicemailsSearchResponse {
    ...
    pub results: Vec<crate::models::VoicemailMessage>,
}

impl VoicemailsSearchResponse {
    pub fn new(total: i64, page_count: i32, page_size: i32, page_number: i32, types: Vec<String>, results: Vec<crate::models::VoicemailMessage>) -> VoicemailsSearchResponse {
