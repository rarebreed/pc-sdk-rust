...
pub struct OutboundRouteBaseEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::OutboundRouteBase>>,
...
impl OutboundRouteBaseEntityListing {
    pub fn new() -> OutboundRouteBaseEntityListing {
