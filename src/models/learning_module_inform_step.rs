...
pub struct LearningModuleInformStep {
...
impl LearningModuleInformStep {
    pub fn new(_type: Type, value: String, order: i32) -> LearningModuleInformStep {
...
pub enum Type {
    ...
    Content,
    #[serde(rename = "GenesysBuiltInCourse")]
