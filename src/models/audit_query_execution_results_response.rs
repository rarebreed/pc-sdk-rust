...
pub struct AuditQueryExecutionResultsResponse {
    ...
    pub entities: Option<Vec<crate::models::AuditLogMessage>>,
}

impl AuditQueryExecutionResultsResponse {
    pub fn new() -> AuditQueryExecutionResultsResponse {
