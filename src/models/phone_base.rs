...
pub struct PhoneBase {
    ...
    #[serde(rename = "phoneMetaBase")]
    pub phone_meta_base: Box<crate::models::DomainEntityRef>,
    /// The list of linebases associated with the phone base.
    #[serde(rename = "lines")]
    pub lines: Vec<crate::models::LineBase>,
...
impl PhoneBase {
    pub fn new(name: String, phone_meta_base: crate::models::DomainEntityRef, lines: Vec<crate::models::LineBase>) -> PhoneBase {
        PhoneBase {
            id: None,
            name,
            division: None,
            ...
            created_by_app: None,
            phone_meta_base: Box::new(phone_meta_base),
            lines,
            properties: None,
            capabilities: None,
            self_uri: None,
