...
pub struct DataTablesDomainEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::DataTable>>,
...
impl DataTablesDomainEntityListing {
    pub fn new() -> DataTablesDomainEntityListing {
