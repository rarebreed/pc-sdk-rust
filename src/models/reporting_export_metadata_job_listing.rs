...
pub struct ReportingExportMetadataJobListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::ReportingExportMetadataJobResponse>>,
...
impl ReportingExportMetadataJobListing {
    pub fn new() -> ReportingExportMetadataJobListing {
