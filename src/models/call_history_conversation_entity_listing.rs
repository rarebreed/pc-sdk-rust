...
pub struct CallHistoryConversationEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::CallHistoryConversation>>,
...
impl CallHistoryConversationEntityListing {
    pub fn new() -> CallHistoryConversationEntityListing {
