...
pub struct DidPool {
    ...
    #[serde(rename = "startPhoneNumber")]
    pub start_phone_number: String,
    /// The ending phone number for the range of this DID pool. Must be in E.164 format
    #[serde(rename = "endPhoneNumber")]
    pub end_phone_number: String,
...
impl DidPool {
    pub fn new(name: String, start_phone_number: String, end_phone_number: String) -> DidPool {
        DidPool {
            id: None,
            name,
            division: None,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum Provider {
    #[serde(rename = "PURE_CLOUD")]
    CLOUD,
    #[serde(rename = "PURE_CLOUD_VOICE")]
    CLOUDVOICE,
}
