...
pub struct ReportRunEntryEntityDomainListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::ReportRunEntry>>,
...
impl ReportRunEntryEntityDomainListing {
    pub fn new() -> ReportRunEntryEntityDomainListing {
