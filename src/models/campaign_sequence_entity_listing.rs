...
pub struct CampaignSequenceEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::CampaignSequence>>,
...
impl CampaignSequenceEntityListing {
    pub fn new() -> CampaignSequenceEntityListing {
