...
pub struct PatchActionMapScheduleGroups {
...
impl PatchActionMapScheduleGroups {
    pub fn new(action_map_schedule_group: crate::models::ActionMapScheduleGroup) -> PatchActionMapScheduleGroups {
