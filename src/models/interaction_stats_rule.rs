...
pub struct InteractionStatsRule {
    ...
    #[serde(rename = "inAlarm", skip_serializing_if = "Option::is_none")]
...
impl InteractionStatsRule {
    pub fn new(name: String, dimension: Dimension, dimension_value: String, metric: Metric, media_type: MediaType, numeric_range: NumericRange, statistic: Statistic, value: f64, enabled: bool, notification_users: Vec<crate::models::User>, alert_types: HashSet<AlertTypes>) -> InteractionStatsRule {
