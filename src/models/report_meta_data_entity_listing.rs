...
pub struct ReportMetaDataEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::ReportMetaData>>,
...
impl ReportMetaDataEntityListing {
    pub fn new() -> ReportMetaDataEntityListing {
