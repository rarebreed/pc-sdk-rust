...
impl Endpoint {
    pub fn new(name: String, schema: crate::models::DomainEntityRef) -> Endpoint {
        Endpoint {
            id: None,
            name,
            division: None,
