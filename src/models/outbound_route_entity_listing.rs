...
pub struct OutboundRouteEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::OutboundRoute>>,
...
impl OutboundRouteEntityListing {
    pub fn new() -> OutboundRouteEntityListing {
