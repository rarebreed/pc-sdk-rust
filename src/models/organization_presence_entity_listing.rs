...
pub struct OrganizationPresenceEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::OrganizationPresence>>,
...
impl OrganizationPresenceEntityListing {
    pub fn new() -> OrganizationPresenceEntityListing {
