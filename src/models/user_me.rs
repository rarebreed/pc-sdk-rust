...
pub struct UserMe {
    ...
    pub date: Option<Box<crate::models::ServerDate>>,
    #[serde(rename = "geolocationSettings", skip_serializing_if = "Option::is_none")]
    pub geolocation_settings: Option<Box<crate::models::GeolocationSettings>>,
    ...
    #[serde(rename = "presenceDefinitions", skip_serializing_if = "Option::is_none")]
    pub presence_definitions: Option<Vec<crate::models::OrganizationPresence>>,
    /// The first 100 site locations for user's organization
    #[serde(rename = "locationDefinitions", skip_serializing_if = "Option::is_none")]
    pub location_definitions: Option<Vec<crate::models::LocationDefinition>>,
    /// The first 100 organization roles, with applicable permission policies, for user's organization.
    #[serde(rename = "orgAuthorization", skip_serializing_if = "Option::is_none")]
    pub org_authorization: Option<Vec<crate::models::DomainOrganizationRole>>,
    /// The first 50 favorited users.
    #[serde(rename = "favorites", skip_serializing_if = "Option::is_none")]
    pub favorites: Option<Vec<crate::models::User>>,
    ...
    #[serde(rename = "adjacents", skip_serializing_if = "Option::is_none")]
    pub adjacents: Option<Box<crate::models::Adjacents>>,
    /// The first 50 routing skills for user's organizations
    #[serde(rename = "routingSkills", skip_serializing_if = "Option::is_none")]
    pub routing_skills: Option<Vec<crate::models::RoutingSkill>>,
    #[serde(rename = "fieldConfigs", skip_serializing_if = "Option::is_none")]
    pub field_configs: Option<Box<crate::models::FieldConfigs>>,
    #[serde(rename = "token", skip_serializing_if = "Option::is_none")]
    pub token: Option<Box<crate::models::TokenInfo>>,
    /// Organizations having this user as a trustee
    #[serde(rename = "trustors", skip_serializing_if = "Option::is_none")]
    pub trustors: Option<Vec<crate::models::Trustor>>,
    /// Products enabled in this organization
    #[serde(rename = "orgProducts", skip_serializing_if = "Option::is_none")]
    pub org_products: Option<Vec<crate::models::DomainOrganizationProduct>>,
...
impl UserMe {
    pub fn new(version: i32) -> UserMe {
        UserMe {
            ...
            date: None,
            geolocation_settings: None,
            organization: None,
            presence_definitions: None,
            location_definitions: None,
            org_authorization: None,
            favorites: None,
            superiors: None,
            direct_reports: None,
            adjacents: None,
