...
pub struct ConversationEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::Conversation>>,
...
impl ConversationEntityListing {
    pub fn new() -> ConversationEntityListing {
