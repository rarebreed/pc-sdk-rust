...
pub struct ExtensionPoolEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::ExtensionPool>>,
...
impl ExtensionPoolEntityListing {
    pub fn new() -> ExtensionPoolEntityListing {
