...
pub struct TwitterIntegrationEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::TwitterIntegration>>,
...
impl TwitterIntegrationEntityListing {
    pub fn new() -> TwitterIntegrationEntityListing {
