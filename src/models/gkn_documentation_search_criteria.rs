...
pub struct GknDocumentationSearchCriteria {
    ...
    pub group: Option<Vec<crate::models::GknDocumentationSearchCriteria>>,
...
impl GknDocumentationSearchCriteria {
    pub fn new(_type: Type) -> GknDocumentationSearchCriteria {
