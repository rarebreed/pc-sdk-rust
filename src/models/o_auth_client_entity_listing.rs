...
pub struct OAuthClientEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::OAuthClientListing>>,
...
impl OAuthClientEntityListing {
    pub fn new() -> OAuthClientEntityListing {
