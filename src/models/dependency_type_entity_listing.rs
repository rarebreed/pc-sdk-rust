...
pub struct DependencyTypeEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::DependencyType>>,
...
impl DependencyTypeEntityListing {
    pub fn new() -> DependencyTypeEntityListing {
