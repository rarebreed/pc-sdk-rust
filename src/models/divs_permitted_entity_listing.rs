...
pub struct DivsPermittedEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::AuthzDivision>>,
    ...
    #[serde(rename = "allDivsPermitted", skip_serializing_if = "Option::is_none")]
    pub all_divs_permitted: Option<bool>,
...
impl DivsPermittedEntityListing {
    pub fn new() -> DivsPermittedEntityListing {
        DivsPermittedEntityListing {
            entities: None,
            page_size: None,
            page_number: None,
            total: None,
            all_divs_permitted: None,
            first_uri: None,
            self_uri: None,
            next_uri: None,
            previous_uri: None,
