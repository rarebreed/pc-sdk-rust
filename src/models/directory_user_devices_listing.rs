...
pub struct DirectoryUserDevicesListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::UserDevice>>,
...
impl DirectoryUserDevicesListing {
    pub fn new() -> DirectoryUserDevicesListing {
