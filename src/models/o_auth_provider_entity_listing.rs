...
pub struct OAuthProviderEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::OAuthProvider>>,
...
impl OAuthProviderEntityListing {
    pub fn new() -> OAuthProviderEntityListing {
