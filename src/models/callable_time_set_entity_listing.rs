...
pub struct CallableTimeSetEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::CallableTimeSet>>,
...
impl CallableTimeSetEntityListing {
    pub fn new() -> CallableTimeSetEntityListing {
