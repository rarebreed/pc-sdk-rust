...
pub struct EvaluatorActivityEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::EvaluatorActivity>>,
...
impl EvaluatorActivityEntityListing {
    pub fn new() -> EvaluatorActivityEntityListing {
