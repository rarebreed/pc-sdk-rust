...
pub struct FlowDivisionViewEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::FlowDivisionView>>,
...
impl FlowDivisionViewEntityListing {
    pub fn new() -> FlowDivisionViewEntityListing {
