...
pub struct CommonCampaignEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::CommonCampaign>>,
...
impl CommonCampaignEntityListing {
    pub fn new() -> CommonCampaignEntityListing {
