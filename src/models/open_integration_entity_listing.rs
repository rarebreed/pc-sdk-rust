...
pub struct OpenIntegrationEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::OpenIntegration>>,
...
impl OpenIntegrationEntityListing {
    pub fn new() -> OpenIntegrationEntityListing {
