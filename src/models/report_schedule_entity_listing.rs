...
pub struct ReportScheduleEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::ReportSchedule>>,
...
impl ReportScheduleEntityListing {
    pub fn new() -> ReportScheduleEntityListing {
