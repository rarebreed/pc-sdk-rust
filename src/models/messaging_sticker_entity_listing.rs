...
pub struct MessagingStickerEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::MessagingSticker>>,
...
impl MessagingStickerEntityListing {
    pub fn new() -> MessagingStickerEntityListing {
