...
pub struct LearningModulesDomainEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::LearningModule>>,
...
impl LearningModulesDomainEntityListing {
    pub fn new() -> LearningModulesDomainEntityListing {
