...
pub struct BotConnectorBotSummaryEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::BotSummary>>,
...
impl BotConnectorBotSummaryEntityListing {
    pub fn new() -> BotConnectorBotSummaryEntityListing {
