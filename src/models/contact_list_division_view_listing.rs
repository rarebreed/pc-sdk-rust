...
pub struct ContactListDivisionViewListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::ContactListDivisionView>>,
...
impl ContactListDivisionViewListing {
    pub fn new() -> ContactListDivisionViewListing {
