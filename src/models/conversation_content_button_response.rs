...
pub struct ConversationContentButtonResponse {
...
impl ConversationContentButtonResponse {
    /// Button response object representing the click of a structured message button, such as a quick reply.
    pub fn new(text: String, payload: String) -> ConversationContentButtonResponse {
