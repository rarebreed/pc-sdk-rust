...
pub struct AuthzDivisionGrantEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::AuthzGrant>>,
...
impl AuthzDivisionGrantEntityListing {
    pub fn new() -> AuthzDivisionGrantEntityListing {
