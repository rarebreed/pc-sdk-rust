...
pub struct CursorRelationshipListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::Relationship>>,
...
impl CursorRelationshipListing {
    pub fn new() -> CursorRelationshipListing {
