...
pub struct CoachingNotificationList {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::CoachingNotification>>,
...
impl CoachingNotificationList {
    pub fn new() -> CoachingNotificationList {
