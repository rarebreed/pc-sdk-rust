...
pub struct BotConnectorBotVersionSummaryEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::BotVersionSummary>>,
...
impl BotConnectorBotVersionSummaryEntityListing {
    pub fn new() -> BotConnectorBotVersionSummaryEntityListing {
