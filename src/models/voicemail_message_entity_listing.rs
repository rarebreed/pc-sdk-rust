...
pub struct VoicemailMessageEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::VoicemailMessage>>,
...
impl VoicemailMessageEntityListing {
    pub fn new() -> VoicemailMessageEntityListing {
