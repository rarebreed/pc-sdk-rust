...
pub struct DomainEdgeSoftwareVersionDtoEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::DomainEdgeSoftwareVersionDto>>,
...
impl DomainEdgeSoftwareVersionDtoEntityListing {
    pub fn new() -> DomainEdgeSoftwareVersionDtoEntityListing {
