...
pub struct ConversationAggregationQuery {
    ...
    pub filter: Option<Box<crate::models::ConversationAggregateQueryFilter>>,
    ...
    pub views: Option<Vec<crate::models::ConversationAggregationView>>,
...
impl ConversationAggregationQuery {
    pub fn new(interval: String, metrics: Vec<Metrics>) -> ConversationAggregationQuery {
