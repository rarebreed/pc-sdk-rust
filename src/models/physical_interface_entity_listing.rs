...
pub struct PhysicalInterfaceEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::DomainPhysicalInterface>>,
...
impl PhysicalInterfaceEntityListing {
    pub fn new() -> PhysicalInterfaceEntityListing {
