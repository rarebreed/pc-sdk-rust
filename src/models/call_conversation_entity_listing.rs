...
pub struct CallConversationEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::CallConversation>>,
...
impl CallConversationEntityListing {
    pub fn new() -> CallConversationEntityListing {
