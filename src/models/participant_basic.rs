...
pub struct ParticipantBasic {
    ...
    pub calls: Option<Vec<crate::models::CallBasic>>,
    #[serde(rename = "callbacks", skip_serializing_if = "Option::is_none")]
    pub callbacks: Option<Vec<crate::models::CallbackBasic>>,
...
impl ParticipantBasic {
    pub fn new() -> ParticipantBasic {
        ParticipantBasic {
            id: None,
            start_time: None,
            end_time: None,
