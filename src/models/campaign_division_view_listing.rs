...
pub struct CampaignDivisionViewListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::CampaignDivisionView>>,
...
impl CampaignDivisionViewListing {
    pub fn new() -> CampaignDivisionViewListing {
