...
pub struct LearningAssignmentAggregateQueryResponseStats {
...
impl LearningAssignmentAggregateQueryResponseStats {
    pub fn new() -> LearningAssignmentAggregateQueryResponseStats {
