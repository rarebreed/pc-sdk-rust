...
pub struct PermissionCollectionEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::DomainPermissionCollection>>,
...
impl PermissionCollectionEntityListing {
    pub fn new() -> PermissionCollectionEntityListing {
