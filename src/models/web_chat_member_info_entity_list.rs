...
pub struct WebChatMemberInfoEntityList {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::WebChatMemberInfo>>,
...
impl WebChatMemberInfoEntityList {
    pub fn new() -> WebChatMemberInfoEntityList {
