...
pub struct DevelopmentActivityAggregateQueryRequestPredicate {
...
impl DevelopmentActivityAggregateQueryRequestPredicate {
    pub fn new(dimension: Dimension, value: String) -> DevelopmentActivityAggregateQueryRequestPredicate {
