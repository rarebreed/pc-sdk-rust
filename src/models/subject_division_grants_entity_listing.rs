...
pub struct SubjectDivisionGrantsEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::SubjectDivisionGrants>>,
...
impl SubjectDivisionGrantsEntityListing {
    pub fn new() -> SubjectDivisionGrantsEntityListing {
