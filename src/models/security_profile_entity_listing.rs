...
pub struct SecurityProfileEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::SecurityProfile>>,
...
impl SecurityProfileEntityListing {
    pub fn new() -> SecurityProfileEntityListing {
