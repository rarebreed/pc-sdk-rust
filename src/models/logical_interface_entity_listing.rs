...
pub struct LogicalInterfaceEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::DomainLogicalInterface>>,
...
impl LogicalInterfaceEntityListing {
    pub fn new() -> LogicalInterfaceEntityListing {
