...
pub struct EdgeGroup {
    ...
    #[serde(rename = "edgeTrunkBaseAssignment")]
    pub edge_trunk_base_assignment: Box<crate::models::TrunkBaseAssignment>,
    /// Trunk base settings of trunkType \"PHONE\" to inherit to edge logical interface for phone communication.
    #[serde(rename = "phoneTrunkBases")]
    pub phone_trunk_bases: Vec<crate::models::TrunkBase>,
...
impl EdgeGroup {
    pub fn new(name: String, edge_trunk_base_assignment: crate::models::TrunkBaseAssignment, phone_trunk_bases: Vec<crate::models::TrunkBase>) -> EdgeGroup {
        EdgeGroup {
            id: None,
            name,
            division: None,
            ...
            managed: None,
            hybrid: None,
            edge_trunk_base_assignment: Box::new(edge_trunk_base_assignment),
            phone_trunk_bases,
            self_uri: None,
        }
    }
