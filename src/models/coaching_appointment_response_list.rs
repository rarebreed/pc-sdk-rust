...
pub struct CoachingAppointmentResponseList {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::CoachingAppointmentResponse>>,
...
impl CoachingAppointmentResponseList {
    pub fn new() -> CoachingAppointmentResponseList {
