...
pub struct TrunkMetabaseEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::Metabase>>,
...
impl TrunkMetabaseEntityListing {
    pub fn new() -> TrunkMetabaseEntityListing {
