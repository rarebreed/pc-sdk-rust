...
impl OpenIntegration {
    pub fn new(id: String, name: String, outbound_notification_webhook_url: String, outbound_notification_webhook_signature_secret_token: String) -> OpenIntegration {
        OpenIntegration {
            id,
            name,
