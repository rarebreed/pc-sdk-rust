...
pub struct PatchActionMap {
    ...
    pub action: Option<Box<crate::models::PatchAction>>,
    #[serde(rename = "actionMapScheduleGroups", skip_serializing_if = "Option::is_none")]
    pub action_map_schedule_groups: Option<Box<crate::models::PatchActionMapScheduleGroups>>,
...
impl PatchActionMap {
    pub fn new(display_name: String, trigger_with_segments: Vec<String>, page_url_conditions: Vec<crate::models::UrlCondition>) -> PatchActionMap {
        PatchActionMap {
            id: None,
            version: None,
            is_active: None,
