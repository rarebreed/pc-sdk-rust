...
pub struct InboundDomainEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::InboundDomain>>,
...
impl InboundDomainEntityListing {
    pub fn new() -> InboundDomainEntityListing {
