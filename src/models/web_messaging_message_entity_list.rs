...
pub struct WebMessagingMessageEntityList {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::WebMessagingMessage>>,
...
impl WebMessagingMessageEntityList {
    pub fn new() -> WebMessagingMessageEntityList {
