...
pub struct FlowMilestoneDivisionViewEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::FlowMilestoneDivisionView>>,
...
impl FlowMilestoneDivisionViewEntityListing {
    pub fn new() -> FlowMilestoneDivisionViewEntityListing {
