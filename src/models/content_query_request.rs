...
pub struct ContentQueryRequest {
    ...
    pub sort: Option<Vec<crate::models::ContentSortItem>>,
    #[serde(rename = "filters", skip_serializing_if = "Option::is_none")]
    pub filters: Option<Vec<crate::models::ContentFacetFilterItem>>,
    #[serde(rename = "attributeFilters", skip_serializing_if = "Option::is_none")]
    pub attribute_filters: Option<Vec<crate::models::ContentAttributeFilterItem>>,
    #[serde(rename = "includeShares", skip_serializing_if = "Option::is_none")]
    pub include_shares: Option<bool>,
}

impl ContentQueryRequest {
    pub fn new() -> ContentQueryRequest {
        ContentQueryRequest {
            query_phrase: None,
            page_number: None,
            page_size: None,
