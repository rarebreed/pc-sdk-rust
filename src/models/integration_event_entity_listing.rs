...
pub struct IntegrationEventEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::IntegrationEvent>>,
...
impl IntegrationEventEntityListing {
    pub fn new() -> IntegrationEventEntityListing {
