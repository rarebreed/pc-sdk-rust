...
pub struct ChatConversationEntityListing {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::ChatConversation>>,
...
impl ChatConversationEntityListing {
    pub fn new() -> ChatConversationEntityListing {
