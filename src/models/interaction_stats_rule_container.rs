...
pub struct InteractionStatsRuleContainer {
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<crate::models::InteractionStatsRule>>,
...
impl InteractionStatsRuleContainer {
    pub fn new() -> InteractionStatsRuleContainer {
